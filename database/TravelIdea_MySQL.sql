...
INSERT INTO `ideas` (`travel_id`, `user_id`, `title`, `destination`, `start_date`, `end_date`) VALUES
...
INSERT INTO `comments` (`comment_id`,`user_id`,`travel_id`,`comment`) VALUES
(1,1,1,'Looking forward to visit Tokyo'),
(2,2,1,'Tokyo is amazing');

INSERT INTO `tags` (`tag_id`,`travel_id`,`tag_name`) VALUES
(1,1,'Tokyo'),
(2,1,'Japan');